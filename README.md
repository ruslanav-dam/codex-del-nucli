...
```
/laberint/
   /r1/          La Porta del Nucli      — push rebutjat
   /r2/          El Polissó del Còdex    — .gitignore + rm --cached
   /r3/          Eco a main              — commit accidental al main
   /r4/          Dues Veritats           — conflicte rename/modify
   /r5/          L'Ombra del Bug         — revert d'un commit pushejat
   /r6/          El Fragment Perdut      — recuperació amb reflog
   /bitacores/   Una subcarpeta per Branchwalker amb les seves bítacores
```
