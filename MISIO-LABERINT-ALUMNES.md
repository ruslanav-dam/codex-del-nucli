...
# El Laberint del Nucli

Missió per a Branchwalkers — Sis reptes pràctics de Git i GitHub.
...
- Si quedeu encallats, **abans de demanar al master** consulteu el receptari de la web: https://ruslanav-dam.github.io/repositorisLIVE → secció *Què faig si...?*
...
> La bítacora val tant com la solució. Repte resolt sense bítacora = mig punt. Repte mig-resolt amb bítacora honesta i raonada = punt sencer.

---

## 3. Reptes i puntuació
...
**PROHIBIT**: `git reset --hard` + `git push --force` a main → repte a 0. La protecció de `main` t'hauria de bloquejar igualment.
...
Al cos del PR, llista quins reptes has completat (R1 fet, R2 fet, R3 fet, R4 no, R5 a mig fer...) amb una frase per cada un.
...
- **Si t'encalles 30 minuts, salta el repte.** Torna-hi més tard.
